...
with tesserocr.PyTessBaseAPI() as api:
    image = Image.open('/Users/mayuukh/Documents/tessaract/sample.jpg')
    in_path = '/Users/mayuukh/Documents/tessaract/sample.jpg'
    out_path = in_path.replace('jpg', '.crop.png')
    newImage = process_image(in_path, out_path)
    newImg = Image.open(out_path)
    api.SetImage(newImg)
